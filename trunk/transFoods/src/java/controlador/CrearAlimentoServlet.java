...
public class CrearAlimentoServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String nombre, marca,  categoria, transgenico;
           ...
           categoria = request.getParameter("cboCategoria");
           transgenico = request.getParameter("cboTrans");
            
            Producto productoNuevo = new Producto( marca,  categoria, transgenico );
            
            DAO dao = new DAO();
            dao.crearProducto(productoNuevo);
